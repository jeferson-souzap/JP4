...
namespace JP4
{
    public partial class AP01 : Form
    {
        ...
        //private DateTime Considera_data(DateTime dia_apon, DateTime hora_apon)
        //{

        //    //Considerar a data somente a partir das 07 horas.
        //    //Se hora for menor 06:59 considerar dia anterior
        //    // Se > 00:00 e < 07:00 considerar a data do dia anterior
        //    return;
        //}
        ...
        private void Carregar_local_aplicacao(string descricao_completa)
        {
            ...
            {
                //string conecta_string = Properties.Settings.Default.db_aplicativo_kpiConnectionString;
                string conecta_string = JP4.Var_Global.Global.string_conection_global;
        ...
        {
            // Descontinuado solicitação do usuario (burrão)
            /*
        ...
        private void Apontar_ordem(string tipo_movimento)
        {
            ...
            int mes_movto = Convert.ToInt32(Convert.ToDateTime(dat_movto).Month);      // DateTime.Today.Month; 
            int ano_movto = Convert.ToInt32(Convert.ToDateTime(dat_movto).Year);   //DateTime.Today.Year;
            ...
            //string peso_medio_bobina = Convert.ToString(Peso_medio_bobina(cod_descri_completa)).Replace(',','.');
            ...
            else
            {
                ...
                //peso_total_fardo = Convert.ToString(resultado_fardo).Replace('.', ',');
            }
            ...
            else
            {
                try
                {
                    peso_medio_bobina = peso_total_fardo / Peso_medio_bobina(cod_descri_completa);
                }
            ...
            try
            {
                ...
                comando_sql = "INSERT INTO estoque_trans(cod_empresa, num_transac, cod_item, cod_descri_completa, cod_descri_reduzida, mes_proces, mes_movto, ano_movto, dat_proces, dat_movto, cod_operacao, num_docum, ies_tip_movto, qtd_real, qtd_movto, num_secao_requis, operador, secao_nome, cod_local_est_orig, cod_local_est_dest, num_lote_orig, num_lote_dest, ies_sit_est_orig, ies_sit_est_dest, cod_turno, nom_usuario, num_prog, largura_material, n_bobina_inical, n_bobina_final, velocidade, contador, fardos, peso_medio_bobina, peso_total_fardo, hora_inical, hora_final, data_operac, hor_operac, Tipo_material, observacao, status_estorno, cliente_apon, razao_social_cliente, marcador_mistura) " +
                    "VALUES('" + cod_empresa + "','" + num_transac + "','" + cod_item + "','" + cod_descri_completa + "','" + cod_descri_reduzida + "','" + mes_proces + "','" + mes_movto + "','" + ano_movto + "','" + dat_proces + "','" + dat_movto + "','" + cod_operacao + "','" + num_docum + "','" + ies_tip_movto + "','" + Convert.ToString(qtd_real).Replace(',','.') + "','" + Convert.ToString(qtd_movto).Replace(',','.') + "','" + num_secao_requis + "','" + operador + "','" + secao_nome + "','" + cod_local_est_orig + "','" + cod_local_est_dest + "','" + num_lote_orig + "','" + num_lote_dest + "','" + ies_sit_est_orig + "','" + ies_sit_est_dest + "','" + cod_turno + "','" + nom_usuario + "','" + num_prog + "','" + largura_material + "','" + n_bobina_inical + "','" + n_bobina_final + "','" + velocidade + "','" + contador_fardos + "','" + fardos + "','" + Convert.ToString(peso_medio_bobina).Replace(',','.') + "','" + Convert.ToString(peso_total_fardo).Replace(',', '.') + "','" + hora_inical + "','" + hora_final + "','" + data_operac + "','" + hor_operac + "','" + Tipo_material + "','" + observacao + "','" + status_estorno + "','" + cliente_apon + "','" + razao_social_cliente + "','" + marcador_mistura + "')";
            ...
            try
            {
                ...
                while (myreader.Read())
                {
                    ...
                    "VALUES('" + cod_empresa + "','" + num_transac + "','" + cod_item + "','" + item_filho + "','" + cod_descri_reduzida + "','" + mes_proces + "','" + mes_movto + "','" + ano_movto + "','" + dat_proces + "','" + dat_movto + "','" + cod_operacao + "','" + num_docum + "','" + ies_tip_movto + "','" + qtd_real + "','" + qtd_movto + "','" + num_secao_requis + "','" + operador + "','" + secao_nome + "','" + cod_local_est_orig + "','" + cod_local_est_dest + "','" + num_lote_orig + "','" + num_lote_dest + "','" + ies_sit_est_orig + "','" + ies_sit_est_dest + "','" + cod_turno + "','" + nom_usuario + "','" + num_prog + "','" + largura_material + "','" + n_bobina_inical + "','" + n_bobina_final + "','" + velocidade + "','" + contador_fardos + "','" + fardos + "','" + peso_medio_bobina + "','" + peso_total_fardo + "','" + hora_inical + "','" + hora_final + "','" + data_operac + "','" + hor_operac + "','" + Tipo_material + "','" + observacao + "')";
                        ...
                        MySqlCommand cmd02 = new MySqlCommand(comando_sql02, conexao);
        ...
        private void Salvar_defeitos_mq(string num_tran)
        {
            ...
            if (AbaDefeito_text_qtd02.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd02.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd03.Text != "0")
            {
                ...
                string operador = label_AbaDefeitos_operador.Text;
                string codigo_defeitos;
                string descricao_defeitos = AbaDefeito_combo_defeito03.Text;
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd03.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd04.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd04.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd05.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd05.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd06.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd06.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd07.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd07.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd08.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd08.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd09.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd09.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
            ...
            if (AbaDefeito_text_qtd10.Text != "0")
            {
                ...
                //double qtd_defeitos = Convert.ToDouble(AbaDefeito_text_qtd01.Text, cultures);
                string qtd_defeitos = AbaDefeito_text_qtd10.Text.Replace(',', '.');
                string observacao = richText_label_AbaDefeitos_obs.Text;
                string num_transac = num_tran;
        ...
        {
            // O calculo não estava sendo feito certo, editado para melhorar. 02/02/2022
                ...
                if (abaMistura_text_perct01.Text != string.Empty)
                {
                    ...
                    try
                    {
                        ...
                        comando_sql = "INSERT INTO db_mp_apon(ordem_prod, maquina, turno, operador, materia_prima, producao, percentual, consumo_mp, dia, mes, ano, data_lancamento, observacao, num_transac, campo_marcador, Tipo_material, marcador_mistura) " +
                          "VALUES('" + ordem_prod + "','" + maquina + "','" + turno + "','" + operador + "','" + materia_prima + "','" + Convert.ToString(producao).Replace(',','.') + "','" + Convert.ToString(percentual).Replace(',','.') + "','" + Convert.ToString(consumo_mp).Replace(',', '.') + "','" + dia + "','" + mes + "','" + ano + "','" + data_lancamento + "','" + observacao + "','" + num_transac + "','" + campo_marcador + "','" + Tipo_material + "','" + marcador_mistura + "')";
        ...
        private void Carregar_campos_apontamento(string id_apontamento)
        {
            ...
            try
            {
                ...
                while (myreader.Read())
                {
                    ...
                    //double peso_medio_bobina = 0; // Fazer metodo pra calcular o peso
                    //double peso_total_fardo = 0; // Fazer metodos pra calcular
                    hr_inicial_prod.Value = Convert.ToDateTime(Convert.ToDateTime(myreader["hora_inical"].ToString()).ToString("HH:mm:ss"));
                    hr_final_prod.Value = Convert.ToDateTime(Convert.ToDateTime(myreader["hora_final"].ToString()).ToString("HH:mm:ss"));
                    dt_lançamento.Value = Convert.ToDateTime(Convert.ToDateTime(myreader["data_operac"].ToString()).ToString("HH:mm:ss")); 
            ...
            try
            {
                ...
                while (myreader.Read())
                {
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada01.Name)
                    {
                        ...
                        abaParada_hr_inicio01.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim01.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada02.Name)
                    {
                        ...
                        abaParada_hr_inicio02.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim02.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total02.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada03.Name)
                    {
                        ...
                        abaParada_hr_inicio03.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim03.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total03.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada04.Name)
                    {
                        ...
                        abaParada_hr_inicio04.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim04.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total04.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada05.Name)
                    {
                        ...
                        abaParada_hr_inicio05.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim05.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total05.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada06.Name)
                    {
                        ...
                        abaParada_hr_inicio06.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim06.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total06.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada07.Name)
                    {
                        ...
                        abaParada_hr_inicio07.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim07.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total07.Text = myreader["total_horas"].ToString();
                    }
                    ...
                    if (myreader["campo_marcador"].ToString() == abaParada_combo_parada08.Name)
                    {
                        ...
                        abaParada_hr_inicio08.Value = Convert.ToDateTime(myreader["hora_inicio"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_hr_fim08.Value = Convert.ToDateTime(myreader["hora_final"].ToString(), CultureInfo.InvariantCulture);
                        abaParada_label_hr_total08.Text = myreader["total_horas"].ToString();
                    }
        ...
        private void Carregar_grid_pesquisar()
        {
            ...
            try
            {
                ...
                string conecta_string = Properties.Settings.Default.db_aplicativo_kpiConnectionString;
                string comando_sql = "select id_estoque_trans, cod_descri_completa, cod_operacao, cliente_apon, num_docum, qtd_real, fardos, operador, secao_nome, cod_turno, mes_movto, ano_movto, dat_movto from estoque_trans where (cod_operacao='" + cod_operacao + "') AND (qtd_real >= 0 AND status_estorno = 0) order by id_estoque_trans desc";

                // order by id_estoque_trans desc
