    ...
    public partial class Form_exportar_dados : Form
    {
        ...
        public void Exportar_dados_MYsql()
        {
            if (MessageBox.Show("Deseja exportar dados antes de fechar?", "Exporta MySQL", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                Thread.Sleep(10);
                barra_status.progressBar_inicial.Value = 14;
                ...
                Exportar_dados_mysql("select * from db_cadastro_equipamento", "cadastro_equipamento", "db_cadastro_equipamento.xlsx");
                Thread.Sleep(10);
                barra_status.progressBar_inicial.Value += 14;

                Exportar_dados_mysql("select * from db_cadastro_tipo_material", "cad_tipo_material", "db_cadastro_tipo_material.xlsx");
                Thread.Sleep(10);
                barra_status.progressBar_inicial.Value += 14;
            }
        }
        ...
        private void button_exportar_todos_Click(object sender, EventArgs e)
        {
            ...
            label_titulo_tabela.Text = "Gerando Tabela de equipamento";
            Exportar_dados_mysql("select * from db_cadastro_equipamento", "cadastro_equipamento", "db_cadastro_equipamento.xlsx");
            progressBar1.Value += 14;

            label_titulo_tabela.Text = "Gerando Tabela de cadastro tipo de material";
            Exportar_dados_mysql("select * from db_cadastro_tipo_material", "cad_tipo_material", "db_cadastro_tipo_material.xlsx");
            progressBar1.Value += 14;
        ...
        private void button_equipamento_Click(object sender, EventArgs e)
        {
            label_titulo_tabela.Text = "Gerando Tabela de cadastro tipo de material";
            Exportar_dados_mysql("select * from db_cadastro_tipo_material", "cad_tipo_material", "db_cadastro_tipo_material.xlsx");
            MessageBox.Show("Salvo com sucesso!");
