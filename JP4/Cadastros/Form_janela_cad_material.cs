...
namespace JP4
{
    public partial class CAD01 : Form
    {
        ...
        private void Atualizar_cadastro(string id_cadastro)
        {
            ...
            string data_modificacao = dt_modificacao.Value.ToString("yyyy/MM/dd");
            ...
            try
            {
                ...
                comando_sql = "UPDATE db_cadastro_material SET " +
                    ...
                    "', peso_padrao='" + Convert.ToString(peso_padrao).Replace(',', '.') +
                    ...
                    "', largura='" + largura +
                    "', densidade='" + densidade +
                    "', espessura='" + Convert.ToString(espessura).Replace(',', '.') +
        ...
        private void Salvar_cadastro()
        {
            ...
            else
            {
                try
                {
                    ...
                    "VALUES('" + codigo_item + "','" + status_item + "','" + grupo + "','" + descricao_reduzida + "','" + descricao_completa + "','" + tipo_material + "','" + qtd_embala + "','" + fator_multi + "','" + peso_minimo + "','" + Convert.ToString(peso_padrao).Replace(',', '.') + "','" + peso_maximo + "','" + unidade_medida + "','" + altura + "','" + comprimento + "','" + largura + "','" + densidade + "','" + Convert.ToString(espessura).Replace(',', '.') + "','" + numero_sacos + "','" + data_modificacao + "','" + local_aplicacao + "','" + local_estoque + "','" + data_cadastro + "','" + tem_estrutura + "','" + empresa + "','" + cod_familia + "')";
